    ...
    const defaultRoles = [
      {
        ...
        permissions: [
          ...
          { module: 'student-management', actions: ['create', 'read', 'update', 'delete'] },
          { module: 'fee-management', actions: ['create', 'read', 'update', 'delete'] },
          { module: 'fee-collection', actions: ['create', 'read', 'update', 'delete'] },
          { module: 'finance-reports', actions: ['create', 'read', 'update', 'delete'] },
        ],
      },
      {
        name: 'Admin',
        ...
        permissions: [
          ...
          { module: 'fee-management', actions: ['create', 'read', 'update', 'delete'] },
          { module: 'fee-collection', actions: ['create', 'read', 'update', 'delete'] },
          { module: 'finance-reports', actions: ['read'] },
        ],
      },
      {
        name: 'Survey Creator',
      ...
      },
      {
        ...
        permissions: [
          ...
          { module: 'school-information', actions: ['read'] },
          { module: 'student-management', actions: ['create', 'read', 'update'] },
          { module: 'fee-management', actions: ['create', 'read', 'update'] },
          { module: 'fee-collection', actions: ['create', 'read', 'update'] },
          { module: 'finance-reports', actions: ['read'] },
        ],
      },
      {
        name: 'Accounts',
        description: 'Collects fees, issues receipts and views collection reports',
        hierarchy: 3,
        permissions: [
          { module: 'dashboard', actions: ['read'] },
          { module: 'student-management', actions: ['read'] },
          { module: 'fee-management', actions: ['read'] },
          { module: 'fee-collection', actions: ['create', 'read', 'update'] },
          { module: 'finance-reports', actions: ['read'] },
        ],
      },
      {
        name: 'Auditor',
        description: 'Read-only access to students, fees, payments and reports',
        hierarchy: 3,
        permissions: [
          { module: 'dashboard', actions: ['read'] },
          { module: 'student-management', actions: ['read'] },
          { module: 'fee-management', actions: ['read'] },
          { module: 'fee-collection', actions: ['read'] },
          { module: 'finance-reports', actions: ['read'] },
          { module: 'activity-logs', actions: ['read'] },
        ],
      },
      {
        name: 'Teacher',
        description: 'Can respond to surveys assigned to them and view students',
        hierarchy: 4,
        permissions: [
